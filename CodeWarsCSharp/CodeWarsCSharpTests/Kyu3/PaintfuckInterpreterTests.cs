...
using CodeWarsCSharp.Kyu3;
using NUnit.Framework;

namespace CodeWarsCSharpTests.Kyu3
{
    public class PaintfuckInterpreterTests
    {
        /// <summary>
        /// https://www.codewars.com/kata/esolang-interpreters-number-3-custom-paintf-star-star-k-interpreter/train/csharp
        /// The default tests are ugly, and rely on a hidden 'Setup' method. Included them here for now so they can be removed later
        /// when actual functionality is being added.
        /// </summary>
        [TestFixture]
        public class Should_work_for_some_example_test_cases
        {
            ...
            {
                string actual = PaintfuckInterpreter.Interpret(code, iterations, width, height);
